 ...
 */
final class Version20220615111132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE objet ADD categorie_id INT DEFAULT NULL, ADD owne_id INT DEFAULT NULL, DROP categorie_id_id, DROP owner_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE objet ADD categorie_id_id INT DEFAULT NULL, ADD owner_id_id INT DEFAULT NULL, DROP categorie_id, DROP owne_id');
